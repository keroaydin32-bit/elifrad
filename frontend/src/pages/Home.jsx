  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative h-[500px] bg-black overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center">
                <div className="container mx-auto px-4">
                  <div className="max-w-xl">
                    ...
                    <h2 className="text-white text-5xl font-bold mb-4">{slide.title}</h2>
                    <p className="text-white text-lg mb-6">{slide.description}</p>
                    <Button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-8 py-6 text-lg uppercase">
                      {slide.buttonText}
                    </Button>
                  </div>
                </div>
        ...
        <button 
          onClick={prevSlide}
          className="absolute left-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-100 p-2 rounded-full transition-all"
        >
          <ChevronLeft className="w-6 h-6" />
        </button>
        <button 
          onClick={nextSlide}
          className="absolute right-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-100 p-2 rounded-full transition-all"
        >
